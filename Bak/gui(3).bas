...
'' Widget Code
Constructor GuiWidget(parent As GuiWidget Ptr, position As Vector3d, dimensions As Vector3d, imargin As Integer Ptr)
	'' Check position correctness and correct automatically so that it doesn't go offscreen
End Constructor
'' End Of Widget Code